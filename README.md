...
> Ports: manager defaults to **3399** (auto-falls back if busy), dsh to **3080**. The dsh checkout path defaults to `D:\AI\DeepSeekHarness\deepseek-harness` and can be passed as `-Checkout`.
